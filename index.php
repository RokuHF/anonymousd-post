...
if(isset($_SESSION['username'])) {
  ...
  if(count($_POST) > 0) {
    ...
    post($name, $comment, $servername, $dbname, $db_user, $db_pass, 'public');
 }
...
<html lang="en">
  ...
  <body>
    ...
    if(isset($_GET['nouser'])) {
      echo "
      <div class=\"alert alert-danger\" role=\"alert\">
        <strong></strong> No user was selected.
      </div>
      ";
    }
    ...
    <!--
      <div class="row">
        ...
        <br>
        <form method='post' action='?success' class="form-group" style="padding-right: 10px;">
          ...
          <div class="table-responsive" style="width:100%;">
            <table class="table table-striped table-bordered" style="table-layout: fixed;">
              ...
              <tbody>
                ...
                <?php
                  //       get_posts($target, $servername, $dbname, $db_user, $db_pass) {
                  $fromuser = 'public';
                  $posts = get_posts($fromuser, $servername, $dbname, $db_user, $db_pass);
                  foreach ($posts as $post) {
                    ...
                    echo "<td>$time</td>";
                    echo "<td>$name</td>";
                    echo "<td style=\"word-wrap: break-word;\">$post</td>";
                    echo "</tr>";
                  }
